    ...
    public void onRun() {
        ...
        for (int i = 0; i < particles; i++) {
            ...
            if (r.nextDouble() < 0.002) { // Random low frequency.
                location.getWorld().playSound(location, Sound.ENTITY_FIREWORK_ROCKET_LAUNCH, 1.5F, 1F);
            }
            if (r.nextDouble() < 0.0005) { // Really low random frequency.
                location.getWorld().playSound(location, Sound.ENTITY_FIREWORK_ROCKET_TWINKLE, 1.5F, r.nextFloat() * 2);
            }
